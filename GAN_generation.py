...
def gen(modeln, parameter_dict):
    ...
    checkpoint_prefix = '/u/student/2024/cs24btnsr11002/2.0/training/GAN_training/' + checkpoint_directory + "/ckpt-"
    generator = Generator(parameter_dict)

    checkpoint = tf.train.Checkpoint(generator=generator)
    manager = tf.train.CheckpointManager(checkpoint, directory='/u/student/2024/cs24btnsr11002/2.0/training/GAN_training/' + checkpoint_directory, max_to_keep=50)
    ...
    np.save('/u/student/2024/cs24btnsr11002/2.0/training/GAN_training/syn/emrwgan_model_'+modeln+'_ckpt_'+parameter_dict['load_checkpoint_number']+'.npy', syn)
...
if __name__ == '__main__':
    ...
    parameter_dict = {}
    parameter_dict['training_data_path'] = '/u/student/2024/cs24btnsr11002/2.0/training/normalized_training_data.csv'
    parameter_dict['feature_range_path'] = '/u/student/2024/cs24btnsr11002/2.0/training/min_max_log.npy'
    parameter_dict['continuous_feature_col_ind'] = [1494,1495,1496,1497]
    parameter_dict['batchsize'] = 4096
    parameter_dict['Z_DIM'] = 128
    parameter_dict['dimension'] = 1498
